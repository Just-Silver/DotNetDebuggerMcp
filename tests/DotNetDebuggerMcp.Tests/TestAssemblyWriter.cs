...
{
    /// <summary>
    /// 自引用深链链长（M0..M6 共 7 个方法）：M0→M1→...→M6 的外部调用链深度超过 <see
    /// cref="DotNetDebugger.Decompiler.Configuration.DecompilerConfig.ExternalExpandMaxDepth"/>，供 ExternalCallExpander 深度上限用例。
    /// </summary>
