...
public class DependenciesToolTests
{
    ...
    {
        var result = await DependenciesTool.Dependencies(TestDataPaths.TestSamplesDll, "ILSpyMcp.Samples.Members");
    ...
    public async Task Dependencies_includeExternal_输出外部段()
    {
        ...
        var result = await DependenciesTool.Dependencies(TestDataPaths.TestSamplesDll, "ILSpyMcp.Samples.Members", includeExternal: true);
    ...
    public async Task Dependencies_includeExternal_无外部引用_输出无占位()
    {
        ...
        var result = await DependenciesTool.Dependencies(TestDataPaths.TestSamplesDll, "ILSpyMcp.Samples.Uses", includeExternal: true);
    ...
    {
        var result = await DependenciesTool.Dependencies(TestDataPaths.TestSamplesDll, "No.Such.Type");
    ...
    {
        var result = await DependenciesTool.Dependencies(TestDataPaths.TestSamplesDll, "");
