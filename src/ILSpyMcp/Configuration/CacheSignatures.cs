...
/// 均引用同一来源，避免新增/改名工具时改一处漏一处（CacheStatsTool 的映射表缺新前缀会显示原始前缀）。
/// 缓存键格式：{Prefix}\u001F{参数...}（无参数时只有 Prefix）。
/// </summary>
internal static class CacheSignatures
{
    ...
    /// <summary>decompile（类型级）。</summary>
    public const string Type = "type";

    /// <summary>decompile_member / call_chain 的成员反编译。</summary>
    public const string Member = "member";

    /// <summary>decompile（整模块）。</summary>
    public const string WholeModule = "whole-module";

    // ---- 元数据类（各工具自行拼接） ----

    /// <summary>list_types。</summary>
    ...
    /// <summary>interface_usage。</summary>
    public const string InterfaceUsage = "interface-usage";

    /// <summary>generic_instantiations。</summary>
