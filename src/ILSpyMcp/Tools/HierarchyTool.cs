...
public static class HierarchyTool
{
    ...
    /// <param name="includeIndirect">是否包含间接后代（如接口的所有实现者、基类的所有子孙，默认 false）。</param>
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        try
        {
            ...
            var descendants = includeIndirect
                ? MetadataHierarchy.GetDescendantsIncludingIndirect(reader, type, fullName)
