...
- **P4-2（WebUI 监视器）进行中** 🔄：Blazor Server + BootstrapBlazor + Monaco 展示面，分支 `feature/p4-monitor`；实际状态以 `open-questions.md` #7 为准。
- **P5（打磨与发布）未开始**。
...
| `open-questions.md` | 开放问题清单（最新在上；#0/#1/#2/#4/#5/#6 已解决折叠，**#7 P4-2 待办活跃**） |
| `plans/2026-09-05-p4-2-webui.md` | **P4-2 实施计划**（进行中，分支 `feature/p4-monitor`） |
| `archive/plans/` | 已完成计划归档：P1 改名拆分 / P2 引擎 v1 / P3 MCP 工具面 / P4-1 DocumentService |
