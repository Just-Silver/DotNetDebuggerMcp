...
| `2026-09-22-screenshot-tool-design.md` | **screenshot 截图工具 spec**（独立工具）：mode=window/screen/region 单工具多模式、WGC 优先+GDI 回退、CallToolResult image 块双轨、PackAsTool hack（spike 实证）、UiSampleApp 测试、Web 冻结不接入 | **已冻结**（三轮审查通过，第三轮 Approved 2026-09-22；转 writing-plans） |
